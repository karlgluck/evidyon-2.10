...
const char* CLIENT_UPDATE_FILES[] = {
  "..\\client\\client.exe", "evidyon.exe",
  "..\\..\\..\\media\\game files\\geona.gme", "evidyon.gme",
};
...
const char* SERVER_UPDATE_FILES[] = {
  ...
  "..\\server\\database.cfg", "database.cfg",
  "..\\..\\..\\media\\game files\\geona.gsvr", "evidyon.gsvr",
  "..\\..\\install-server\\config.ini", "config.ini",
};
static const int NUMBER_OF_SERVER_UPDATE_FILES = (sizeof(SERVER_UPDATE_FILES) / sizeof(const char*)) / 2;

const char* EVIDYON_INSTALLER_SRC = "..\\install-evidyon\\install-evidyon.msi";
const char* EVIDYON_INSTALLER_DEST = "install-evidyon.msi";

const char* SERVER_INSTALLER_SRC = "..\\install-server\\install-server.msi";
...
int main() {
  ...
  static const char* FTP_USERNAME = "PUT YOUR FTP USERNAME HERE";
  static const char* FTP_PASSWORD = "PUT YOUR FTP PASSWORD HERE";
  { // update the client
