...
const char* decodeString(const char* sourceBuffer, const char* endOfSourceBuffer, std::string* outString)
{
  ...
  // Make sure this string is valid.  We do three checks here, since reading strings of variable
  // length is security hole that is a likely place of attack by hackers.
