//------------------------------------------------------------------------------------------------
// File:    resourceactions.cpp
//
// Desc:    Resolves all of the dc::dcClass<T>::actions[] arrays.
//
...
//------------------------------------------------------------------------------------------------
// Name:  ClearReference
// Desc:  Erases a reference's target
//------------------------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------------------------
// Name:  ImportSubdividedImages
// Desc:  Lets the user pick images that contain multiple sub-images and import them
//------------------------------------------------------------------------------------------------
  ...
  for (int level = 0; level < HIGHEST_DEFINED_LEVEL; ++level) {
    ...
    for (int i = 0; i < AVATARCLASS_COUNT; ++i) {
      ...
      case AVATARCLASS_KNIGHT:
        stats[0] = 10 + (int)(level / 2.0);
        stats[2] = 10 + (int)(level / 2.5);
        stats[3] = 10 + (int)(level / 5.0);
        stats[4] = 10 + (int)(level / 7.0);
        break;
      case AVATARCLASS_SORCERER:
        stats[0] = 10 + (int)(level / 7.0);
        stats[2] = 10 + (int)(level / 2.35);
        stats[3] = 10 + (int)(level / 3.0);
        stats[4] = 10 + (int)(level / 3.0);
        break;
      }
      class_hp[i] = 
