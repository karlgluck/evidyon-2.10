//------------------------------------------------------------------------------------------------
// File:    projectvolucriseditor.cpp
//
// Desc:    
//
...
// Project constants
const char PV_FILE_FILTER[] = "Project Volucris Configuration (*.mvc)\0*.mvc\0\0";
const char PV_FILE_EXTENSION[] = ".mvc";
const char PV_EXPORT_FILE_FILTER[] = "Project Volucris Exported Projects (*.evc)\0*.evc\0\0";
const char PV_EXPORT_FILE_EXTENSION[] = ".evc";
const char PV_CLIENT_COMPILE_FILE_FILTER[] = "Project Volucris Game File (*.gme)\0*.gme\0\0";
const char PV_CLIENT_COMPILE_FILE_EXTENSION[] = ".gme";
const char PV_SERVER_COMPILE_FILE_EXTENSION[] = ".gsvr";
const char PV_RESOURCEPACK_FILE_FILTER[] = "Project Volucris Resource Pack (*.pvk)\0*.pvk\0\0";
const char PV_RESOURCEPACK_FILE_EXTENSION[] = ".pvk";
