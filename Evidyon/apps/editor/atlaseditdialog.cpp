...
bool AtlasEditDialog::compile(AtlasCompilationContext* context)
{
    ...
    context->setSpawnInfo(myAtlas->getSpawnLocationValue().first, myAtlas->getSpawnLocationValue().second, myAtlas->getSpawnRadiusValue());
...
//    BYTE b = (BYTE)(255.0f*cosf(dcxWin32Clock::getAccurateSystemTime()/2.0f));
    ...
    // Build the camera
    myCamera.rebuild(800, 600, myZoom);
    //myCamera.rebuildXenimusCamera(800, 600);
