...
//------------------------------------------------------------------------------------------------
VolucrisGUIGlobalChatDisplay::GlobalChatLine::GlobalChatLine()
    : text_element_(this) {
  zero();
}
...
//------------------------------------------------------------------------------------------------
void VolucrisGUIGlobalChatDisplay::GlobalChatLine::initialize(GUIFont* font) {
...
//------------------------------------------------------------------------------------------------
void VolucrisGUIGlobalChatDisplay::GlobalChatLine::set(D3DCOLOR color, const std::string& text) {
...
//------------------------------------------------------------------------------------------------
void VolucrisGUIGlobalChatDisplay::GlobalChatLine::registerElements(GUILayer* layer) {
  text_element_.registerElements(layer);
}


//------------------------------------------------------------------------------------------------
void VolucrisGUIGlobalChatDisplay::GlobalChatLine::unregisterElements(GUILayer* layer) {
  text_element_.unregisterElements(layer);
}


//------------------------------------------------------------------------------------------------
void VolucrisGUIGlobalChatDisplay::GlobalChatLine::refresh() {
...
//------------------------------------------------------------------------------------------------
void VolucrisGUIGlobalChatDisplay::GlobalChatLine::zero() {
...
//------------------------------------------------------------------------------------------------
VolucrisGUIGlobalChatDisplay::VolucrisGUIGlobalChatDisplay() {
  zero();
}
...
//------------------------------------------------------------------------------------------------
bool VolucrisGUIGlobalChatDisplay::create(GUIFont* text_font,
...
//------------------------------------------------------------------------------------------------
void VolucrisGUIGlobalChatDisplay::destroy() {
  hide();
  zero();
}
...
//------------------------------------------------------------------------------------------------
void VolucrisGUIGlobalChatDisplay::show(GUILayer* layer) {
...
//------------------------------------------------------------------------------------------------
void VolucrisGUIGlobalChatDisplay::addSystemText(const std::string& system_text) {
  addLine(system_text, system_text.length()/2, VolucrisGUIChatLog::SYSTEM_TEXT_COLOR);
}

//------------------------------------------------------------------------------------------------
void VolucrisGUIGlobalChatDisplay::addPartyTextLine(const std::string& speaker_name, const std::string& text) {
  std::string chat_line = speaker_name;
  chat_line.append(":  ");
  chat_line.append(text);
  addLine(chat_line, speaker_name.length() + 1, VolucrisGUIChatLog::PARTY_TEXT_COLOR);
}

//------------------------------------------------------------------------------------------------
void VolucrisGUIGlobalChatDisplay::update(double time) {
...
//------------------------------------------------------------------------------------------------
void VolucrisGUIGlobalChatDisplay::addLine(const std::string& text_line, int split_character_index, D3DCOLOR color) {
  GUISize text_size;
...
//------------------------------------------------------------------------------------------------
void VolucrisGUIGlobalChatDisplay::ensureSpaceForNewLines(int number) {
...
//------------------------------------------------------------------------------------------------
unsigned int VolucrisGUIGlobalChatDisplay::getNumberOfLines() const {
...
//------------------------------------------------------------------------------------------------
GUIList::ListEntry* VolucrisGUIGlobalChatDisplay::getListEntry(unsigned int index) {
  return (index < num_lines_used_) ? &lines_[(first_line_index_ + index)%MAXIMUM_LINES] : NULL;
}


//------------------------------------------------------------------------------------------------
void VolucrisGUIGlobalChatDisplay::zero() {
  layer_ = NULL;
